          ...
          <Grid container spacing={10}>
            <Grid item md={6}>
              ...
              <Typography variant="h6" align="left" color="textSecondary">
                AROMA & PALATE:
                Rich aromas of brine. The palate is balanced, full, and buttery. More notes of brininess and ocean breeze on the palate. Very pleasant.
              </Typography>
              <Typography variant="h6" align="left" color="textSecondary" style={{ paddingTop: '18px' }}>
                FINISH:
                Aroma of seaweed and fresh rhubarb. Oily finish.
              </Typography>
              <Typography variant="h6" component="h6" align="left" color="textPrimary" style={{ paddingTop: '18px' }}>
                “Earthy, smoky nose; Silky and earthy with vegetal flavors and some sweet vanilla notes; Smooth and lush, balanced and long.” – Anthony Dias Blue, Renowned spirits critic"
              </Typography>
            </Grid>
            <Grid item md={6}>
              <Typography variant="h5" component="h5" align="left" color="textPrimary" >
