		      ...
		      <Container>
	      		<Grid container spacing={6}>
	      			<Grid item xs={12} sm={12} md={6}>
				      		...
				      		<Typography variant="h2" align="left" color="textPrimary" gutterBottom className={classes.storyHeader} id="process-header">
	      ...
	      <div className={classes.storyContent2}>
	      	...
	      	<Container>
	      		<Grid container spacing={10}>
		      		...
		      		<Grid item xs={12} sm={12} md={6}>
								<Fade bottom distance="20px" duration="800">
		      				<Typography variant="h2" component="h2" align="left" color="textPrimary" gutterBottom className={classes.storyHeader} id="process-header">
				            Meet our Mezcaleros
				          </Typography>
				         	<Typography variant="h5" align="left" color="textSecondary" paragraph className={classes.storyText1}>
