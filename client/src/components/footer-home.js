...
export default function Footer() {
  ...
  return (
    <main style={{ backgroundColor: 'white' }} className="footer-z">
      
      <Divider />

        <div className={classes.footerContent} id="footer-padding" >
          <Grid 
              container
              direction="row"
              justify="center"
            ...
            <Grid item xs={12} sm={4}>
              <Typography variant="h5" align="left" color="textSecondary" paragraph className={classes.footerText2} id="footer-top">
                TO LEADING A LIFE FREE OF LABELS... CHEERS!
              </Typography>
              <Typography variant="h5" align="left" color="textSecondary" paragraph className={classes.footerText} id="footer-bottom">
              ...
              <Typography variant="h5" align="left" color="textSecondary" paragraph className={classes.footerText} style={{ paddingTop: '12px' }} id="footer-bottom">
                © Paquera Mezcal 2020
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={2} position="center">
              ...
              <a href="/shop/" className="footer-menu">
                <p> Shop Online </p>
              </a>
              <a href="/blog/" className="footer-menu">
                <p> Read Our Blog </p>
              </a>
              <a href="/stockists/" className="footer-menu">
                <p> Stockists </p>
              </a>
              <a href="/" className="footer-menu">
                <p> Contact Us </p>
            ...
            <Grid item xs={12} sm={4}>
              ...
              <TextField className="footer-input" id="outlined-basic" label="Email address" variant="outlined" style={{ width: '100%' }}/>
              <Button
                variant="contained"
                color="primary"
