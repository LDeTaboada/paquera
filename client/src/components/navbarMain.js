    ...
    <div className={classes.root}>
      <CssBaseline />
          ...
          <Container fluid>
            <Toolbar>
              ...
              <Grid item xs={10} sm={8} >
                <Typography variant="h1" id="nav-text">
                  PAQUERA MEZCAL
                </Typography>
              </Grid>
            </Grid>
        ...
        <a href="/" id="drawer-text">
          <ListItem button id="drawer-text">
            <ListItemText primary="Home" id='drawer-text' />
          </ListItem>
        </a>

            <a href="/shop/" className="drawer-text">
              <ListItem button className="drawer-text">

                <ListItemText primary="Shop Paquera" className='drawer-text' />
              </ListItem>
            </a>
            ...
            <a href="/oaxaca-process/">
              <ListItem button>
                ...
                <ListItemText primary="Oaxaca Process" id='drawer-text'/>
              </ListItem>
            </a>
            ...
            <a href="/story/">
              <ListItem button>
                ...
                <ListItemText primary="Story" id='drawer-text'/>
              </ListItem>
            </a>
          ...
          <a href="/stockists/">
            <ListItem button>
              ...
              <ListItemText primary="Stockists" id='drawer-text'/>
            </ListItem>
          </a>
            ...
            >
              <a href="/blog/">
                <ListItem button className={classes.nested}>
                  ...
                  <ListItemText primary="All Articles" id='drawer-text'/>
                </ListItem>
              </a>
              <a href="/blog/cocktails/">
                <ListItem button className={classes.nested}>

                  <ListItemText primary="Cocktails" id='drawer-text'/>
                </ListItem>
              </a>
              <a href="/blog/about/" id="drawer-text">
                <ListItem button className={classes.nested} id="drawer-text">
                  <ListItemText primary="About Paquera" id='drawer-text'/>
                </ListItem>
              </a>
            </List>
          </Collapse>
          ...
          <a href="/story/">
            <ListItem button>
              ...
              <ListItemText primary="Contact"  id='drawer-text'/>
            </ListItem>
          </a>
